...
output "id" {
  description = "the ID of the mysql server ad administrator"
  value       = azurerm_mysql_flexible_server_active_directory_administrator.administrator.id
}

output "tenant_id" {
  description = "the tenant id of the mysql server ad administrator"
  value       = azurerm_mysql_flexible_server_active_directory_administrator.administrator.tenant_id
}
